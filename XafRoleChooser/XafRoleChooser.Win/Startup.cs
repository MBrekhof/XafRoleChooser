...
namespace XafRoleChooser.Win
{
    public class ApplicationBuilder : IDesignTimeApplicationFactory
    {
        public static WinApplication BuildApplication(string connectionString)
        {
            ...
            builder.UseApplication<XafRoleChooserWindowsFormsApplication>();
            builder.Modules
            ...
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options =>
                {
                    ...
                    .WithDbContext<XafRoleChooser.Module.BusinessObjects.XafRoleChooserEFCoreDbContext>((application, options) =>
                    {
